...
<body>
    ...
    <!-- HERO VIDEO -->
    <section id="home" class="hero-section text-white text-center d-flex align-items-center justify-content-center" data-aos="fade-up">
        <video autoplay muted loop playsinline class="hero-video lazyload"
               data-src="{{ asset('videos/vidbg.mp4') }}">
...
<section id="why" class="why-section d-flex align-items-center mx-auto mb-5" data-aos="fade-up">
    <div class="container-fluid p-0">
        <div class="row g-0">
            ...
            <div class="col-lg-6 image-section">
                <img src="{{ asset('images/mengapaakar.jpg') }}" alt="Mengapa AkarFarm" class="img-fluid w-100 h-100">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="carousel-inner">
                @foreach ([
                    ['images/areasawah.jpg','Bayangkan Area Persawahan Konvensional',
                     'Bayangkan Kini Waktunya Miliki Area Persawahan Sendiri disini dan Bebas Tanam Apapun. Kamu Bisa Tanam Berbagai Macam Jenis Tanaman Tanpa Khawatir Lahan, Air dan Jauh Lebih Hemat.'],
                    ['images/bagiarea.jpg','Kita Bagi Area Tersebut',
                     'Tujuan Membagi Area Tersebut Untuk Menghasilkan Tanaman Yang Bervariasi dan Produksi Menjadi Lebih Banyak.'],
                    ['images/areaditumpuk.jpg','Area-Area Kemudian Ditumpuk',
                     'Metode Utama Kami Merupakan Modular Indoor Vertical Farming. Bertani Di Ruang Tertutup Yang Terkontrol Di Area Terbatas Namun Bisa Menghasilkan Tanaman Berkualitas Tanpa Batas.'],
                    ['images/ruangterkontrol.jpg','Taruh Area Tersebut Di Ruang Terkontrol',
                     'Selain Menjaga Tanaman Terhindar Dari Penyakit Dan Hama. Ruangan Terkontrol Berfungsi Untuk Mengatur Temperatur, Pencahayaan, Kelembapan Untuk Pertumbuhan Tanaman.'],
                    ...
                    ['images/kontrol.jpg','Kontrol Kapanpun, Monitor Dimanapun',
                     'Mengontrol Secara Berkala Untuk Hasil Tani Tanpa Kendala Di Segala Cuaca. Waktu Panenmu Kini Fokus Pada Kemampuan Tumbuh Setiap Tanaman Yang Berbeda-Beda. Kamu Tidak Perlu Menghabiskan Banyak Waktu.']
                ] as $index => $slide)
    ...
    <section class="produk-section py-5" data-aos="fade-up">
    <div class="container text-center mb-5">
        <h2 class="fw-semibold">Produk Kami, <br>Akar dan Akar+</h2>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card p-4 text-white h-100 shadow-lg border-0">
                    <ul class="text-start list-unstyled mb-4">
                        <li class="mb-2"><i class="bi bi-check2"></i> Gratis Maintenance</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Gratis Sales</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Penjualan Tetap</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> 500 Lubang Tanam</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Panen 1–2 kg/hari</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Hemat Listrik</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Hemat Air</li>
                        <li class="mb-2"><i class="bi bi-check2"></i> Fix Income Rp1jt/bulan</li>
                    </ul>

                    <div class="text-center mt-auto">
                        <h5 class="fw-bold">AKAR</h5>
                        <p class="mb-1">Panen bersama unit modular 5 tingkat unit AKAR</p>
                        <small>(1.5 × 0.7 × 2.5 m)</small>

                        <div class="mt-3">
                            <span class="text-decoration-line-through text-light opacity-75">Rp 2.000.000</span>
                            <h2 class="fw-bold mb-3">Rp 499.000</h2>
                        </div>

                        <button class="btn btn-light rounded-pill px-4 fw-semibold text-success">
                            Rental Sekarang
                        </button>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card p-4 text-white h-100 shadow-lg border-0">
                    ...
                    <div class="text-center mt-auto">
                        <h5 class="fw-bold">AKAR+</h5>
                        <p class="mb-1">Panen bersama unit modular 7 tingkat unit AKAR</p>
                        <small>(1.5 × 0.7 × 3.2 m)</small>

                        <div class="mt-3">
                            <span class="text-decoration-line-through text-light opacity-75">Rp 3.500.000</span>
                            <h2 class="fw-bold mb-3">Rp 999.000</h2>
                        </div>
    ...
    <section id="plants" class="plants-section text-white mb-5" data-aos="fade-up">
        <div class="plants-container mx-auto">
            <div class="row g-0 justify-content-center">
                @php
                    $plants = [
                        ['name' => 'Selada Iceberg', 'desc' => 'Renyah dan segar dari kebun hidroponik.', 'img' => '/images/selada-hidroponik.jpg'],
                        ['name' => 'Kale Nero', 'desc' => 'Kaya nutrisi dan rasa yang khas.', 'img' => '/images/tanaman-kale.jpg'],
                        ['name' => 'Bayam Merah', 'desc' => 'Warna cerah, tinggi zat besi.', 'img' => '/images/bayam-merah.jpg'],
...
<section id="visi" class="visi-section py-5 mx-auto mb-5" data-aos="fade-up">
    <div class="container d-flex align-items-center justify-content-between flex-wrap">
        ...
        <div class="visi-text col-lg-4 col-md-12 mb-4 mb-lg-0 text-white">
            ...
            <p class="text-center">
                Menjadi Garda Terdepan Di Bidang Agrikultur Melalui Inovasi Dan Teknologi Untuk Kemajuan Urban Farming Nusantara.
            </p>
        </div>
        ...
        <div class="visi-text col-lg-4 col-md-12 text-white">
            ...
            <p class="text-center">
                Menciptakan Platform Yang Cocok Untuk Petani Di Indonesia Melalui Teknologi Pertanian Yang Dapat Dimanfaatkan Secara Komersial Di Seluruh Indonesia.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="logo-track d-flex align-items-center">
          @foreach (File::files(public_path('images/logo')) as $file)
            <div class="logo-item mx-4">
              <img src="{{ asset('images/logo/' . $file->getFilename()) }}" alt="Partner Logo" class="img-fluid" />
            </div>
          @endforeach
        </div>
      @endfor
